<section id="impressum">
  ...
  <p>
    ...
    <br />
    <br />
    <b>Unternehmensgegenstand:</b> Verein<br />
    <b>ZVR-Zahl:</b> ATU12345678
    <br />
    <br />
    <b>Tel.:</b> 06605083353
    <br />
    <b>E-Mail:</b> verein-bele@posteo.org
    <br />
    <b>Mitglied bei:</b> Kulturvernetzung NÖ<br />
    <b>Berufsrecht:</b> Gewerbeordnung: www.ris.bka.gv.at
    <br />
    <b>Aufsichtsbehörde/Gewerbebehörde:</b> Bezirkshauptmannschaft Melk<br />
    <b>Berufsbezeichnung:</b> Webdesigner, Grafiker<br />
  ...
  <p>
    <b
      ...
      der verantwortlichen Person bzw. Stelle:</b
    ><br />
    <br />
    Verein Bele<br />
    Wimbergeramt 22<br /> 4392 Dorfstetten, Österreich<br />
    <b>Vertretungsberechtigt:</b> Maria Buchegger<br />
    <b>E-Mail-Adresse:</b> verein-bele@posteo.org
  </p>
  ...
  die seitens Dritter bereitgestellt wurden. Als Diensteanbieter sind wir nicht verpflichtet,
  ...
  behördlichen Anordnungen bleiben auch im Falle unserer Nichtverantwortlichkeit
  davon unberührt.<br />
  Sollten Ihnen problematische oder rechtswidrige Inhalte auffallen, bitte wir Sie
  uns umgehend zu kontaktieren, damit wir die rechtswidrigen Inhalte entfernen können.
  Sie finden die Kontaktdaten im Impressum. <br /><br />
  ...
  Die Bilderrechte liegen bei den folgenden Fotografen und Unternehmen: Verein
  BELE<br /><br />
