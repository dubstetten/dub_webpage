...
<section id="datenschutz">
  ...
  <p>
    ...
    durch den Websitebetreiber Verein BELE informieren.<br />
  ...
  <p>
    ...
    Website ab. Folgende Daten werden so protokolliert:<br />
  ...
  <p>
    ...
    Nutzers Muster von datenschutz.org<br />
  ...
  <p>
    ...
    E-Mail-Adresse und Telefonnummer.<br /><br />
  ...
  <p>
    ...
    zu erhalten, welche personenbezogenen Daten über Sie gespeichert wurden. Sie
  ...
  <p>
    ...
    Löschung Ihrer Daten. Von uns gespeicherte Daten werden, sollten sie für
    ihre Zweckbestimmung nicht mehr vonnöten sein und es keine gesetzlichen
    ...
    werden die Daten gesperrt und nicht für andere Zwecke verarbeitet.<br /><br
    />
  </p>
  ...
  <p>
    ...
    widersprechen. Wenn Sie eine Berichtigung, Sperrung, Löschung oder Auskunft
    ...
    möchten, wenden Sie sich bitte an folgende E-Mail-Adresse:<br />
